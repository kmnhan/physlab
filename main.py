        ...
        if params["manual"]:
            ...
            msg = "<br>".join(
                [
                    ...
                    "<hr><h5>Measurement Steps</h5><ul>",
                    f"<li>[1] Ramp to {params['tempstart']} K, {params['coolrate']} K/min</li>",
                    f"<li>[2] Wait {params['delay']} min</li>",
                    f"<li>[3] Ramp to {params['tempend']} K, {params['heatrate']} K/min</li>",
                    "</ul><hr><h5>Estimated Measurement Timeline</h5>",
